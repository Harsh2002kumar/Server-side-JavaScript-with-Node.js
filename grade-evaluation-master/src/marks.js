...
const calculateTotalMarks = async (
  ...
  return new Promise((resolve, reject) => {
    setTimeout((err) => {
      if (english == undefined) reject("Null values for marks");
...
const calculateGrade = async (averageMarks) => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      ...
      else if (averageMarks >= 80 && averageMarks < 90) grade = "A";
      else if (averageMarks >= 70 && averageMarks < 80) grade = "B";
      else if (averageMarks >= 60 && averageMarks < 70) grade = "C";
      else if (averageMarks >= 50 && averageMarks < 60) grade = "E";
